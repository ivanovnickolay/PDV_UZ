...
class prepareSQDataOutINNByOne
{
	 ...
	 */
	public function __construct(workDateForSQL $workDateForSQL, string $numBranch)
	{
	...
	*/
	...
	private function getArrayForBindValueWithPeriod(){
		...
		$this->arrayForBindValueWithPeriod["nb"]=$this->numBranch;
	...
	private function getArrayForBindValueWithoutPeriod(){
		...
		$this->arrayForBindValueWithoutPeriod["nb"]=$this->numBranch;
