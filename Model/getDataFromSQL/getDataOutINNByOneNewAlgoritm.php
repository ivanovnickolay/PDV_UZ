...
use App\Model\getDataFromSQL\prepareSQL\prepareSQDataOutINNByOne;
 ...
 */
class getDataOutINNByOneNewAlgoritm extends getDataFromAnalizAbstract
{
	/**
	 * месяц анализа
	 * @var int
	...
	public function init($month, $year, $numBranch)
	{
		...
		$this->prepareSQLData=new prepareSQDataOutINNByOne($this->workDate, $this->numBranch);
	 ...
	 */
	public function getReestrEqualErpn()
	{
	 ...
	 * @uses writeAnalizOutByInn::writeAnalizPDVOutInnByOneBranchWithDoc - отсюда вызывается функция
	 */
	public function getReestrEqualErpn_DocErpn(){
		$arrayResult=$this->executeSQLWithReturn(
	 ...
	 * @uses writeAnalizOutByInn::writeAnalizPDVOutInnByOneBranchWithDoc - отсюда вызывается функция
	 */
	public function getReestrEqualErpn_DocReestr(){
		$arrayResult=$this->executeSQLWithReturn(
	 ...
	 * @uses writeAnalizOutByInn::writeAnalizPDVOutInnByOneBranchWithDoc - отсюда вызывается функция
	 */
	public function getReestrNoEqualErpn(){
		$arrayResult=$this->executeSQLWithReturn(
	 ...
	 * @uses writeAnalizOutByInn::writeAnalizPDVOutInnByOneBranchWithDoc - отсюда вызывается функция
	 */
	public function getReestrNoEqualErpn_DocReestr(){
		$arrayResult=$this->executeSQLWithReturn(
	 ...
	 * @uses writeAnalizOutByInn::writeAnalizPDVOutInnByOneBranchWithDoc - отсюда вызывается функция
	 */
	public function getErpnNoEqualReestr(){
		$arrayResult=$this->executeSQLWithReturn(
	 ...
	 * @uses writeAnalizOutByInn::writeAnalizPDVOutInnByOneBranchWithDoc - отсюда вызывается функция
	 */
	public function getErpnNoEqualReestr_DocErpn(){
		$arrayResult=$this->executeSQLWithReturn(
